									...
									if (numberOfRows > 0) {
										...
										for (int i=0;i< numberOfRows;i++) {
											...
											if (request.getAttribute("pid"+i+"fedoraObjectType").equals("file")) {
												...
												out.println("<td><a href=DownloadRequestHandler?namespaceandpid="+request.getAttribute("collectionName"+i)+":"+request.getAttribute("parentFolderNameForDuracloud"+i)+"/"+request.getAttribute("baseFileName"+i)+"&"+request.getAttribute("collectionName"+i)+request.getAttribute("parentFolderNameForDuracloud"+i)+"/"+request.getAttribute("baseFileName"+i)+"="+request.getAttribute("fileExtension"+i)+"&fedoraObjectName="+request.getAttribute("projectName")+":"+request.getAttribute("collectionName"+i)+">"+request.getAttribute("alphaNumericName"+i)+"</a></td>");
											}
											else {
