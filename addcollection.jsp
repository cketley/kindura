	...
	<head>
		...
		<script type="text/javascript">
			function validateCollectionTitle() {
				var collectiontitle = document.forms["metadata"]["collectionName"].value;
			...
			function validateAssociatedProject() {
				var projectname = document.forms["metadata"]["projectName"].value;
				if (projectname == "" || projectname == null) {
					alert("Please select 'Associated Project' for the data collection.");
				}
			}
			function validateVersion() {
				var version = document.forms["metadata"]["version"].value;
				if (version == "" || version == null) {
					alert("Please select 'Version' for the data collection.");
				}
			}
			function validateAccessFrequency() {
				var accessfrequency = document.forms["metadata"]["accessFrequency"].value;
			...
			function validateProtectiveMarking() {
				var protectivemarking = document.forms["metadata"]["protectiveMarking"].value;
